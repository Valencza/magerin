...
<body>
    ...
    <!-- Genre dropdown ends-->
                        ...
                        <li class="dropdown" style="
                            ...
                            <img src="<?php echo $data['foto_profile'] ?>" alt style="width: 50px; height: 50px; border: 1px solid white; border-radius: 30px;" />
                            </a>
        ...
        <div class="maincontainer">
            ...
            ?>
                <div class="video-container">
                    ...
                    <div class="video-player" style="margin-right: 20px;">
